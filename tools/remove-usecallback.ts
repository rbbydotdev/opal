//jscodeshift -t remove-usecallback.js src --extensions=js,jsx,ts,tsx --parser=tsx
module.exports = function transformer(file, api) {
  ...
  root
    ...
    .forEach((path) => {
      ...
      const filtered = specifiers.filter((s) => !(s.type === "ImportSpecifier" && s.imported.name === "useCallback"));
