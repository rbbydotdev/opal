export const Opal = ({ size = 28, invert }: { size?: number; invert?: boolean }) => (
  <svg
    width={size}
    height={size}
    style={{ filter: invert ? "invert(1)" : "none" }} // Apply the invert filter conditionally
    viewBox="0 0 28 28"
