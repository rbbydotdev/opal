...
export const DocImage = ({ src, className, ...props }) => (
  <div className="relative" style={{
    position: "relative",
  }}>
    <img className={cn("p-4 w-96 h-96 relative border-2 border-dashed rounded-lg", className)} src={src}
      {...props}
    />
  </div>
)

<div className="mb-12 relative flex justify-center items-center w-full bg-white rounded-lg">
  ...
  ></div>
  <img alt="Opal" title="Opal" src="/docs/drawn-opal.svg" style={{ width: "12rem", margin: "3rem", position:"relative", zIndex: 20 }} />
</div>
...
{/* <DocImage src="/docs/add-image.svg" />
<DocImage src="/docs/browser-bolt.svg" />
<DocImage src="/docs/dnd-image.svg" />
<DocImage src="/docs/file-tree.svg" />
<DocImage src="/docs/hash-headings.svg" />
<DocImage src="/docs/hello-world-editor.svg" />
<DocImage src="/docs/history-menu.svg" className="w-[800px]" />
<DocImage src="/docs/markdown-tree.svg" />
<DocImage src="/docs/md-arrow.svg" />
<DocImage src="/docs/my-build.svg" />
<DocImage src="/docs/new-ws-modal.svg" />
<DocImage src="/docs/publish-modal.svg" />
<DocImage src="/docs/rich-text-tools.svg" />
<DocImage src="/docs/search-doc.svg" />
<DocImage src="/docs/stone-menu.svg" />
<DocImage src="/docs/trash-banner.svg" />
<DocImage src="/docs/publish-providers.svg" />
<DocImage src="/docs/git-mgmt.svg" /> */}
...
- Files in Trash can be viewed, edited, and restored with the banner prompt, or via context menu options.
