...
//   static async findFilesRecursively(dirPath: string, filter?: (file: FileInfo) => boolean): Promise<string[]> {
//     const files: string[] = [];
...
//     posts: Array<{ frontMatter: any; [key: string]: any }>
//   ): Array<{ frontMatter: any; [key: string]: any }> {
...
//     const htmlFiles = await this.findFilesRecursively(outputPath, (file) => file.extension === ".html");
