  ...
  return (
    ...
    >
      <Button
        ...
        className="border backdrop-blur-lg !bg-transparent absolute left-0 peer/putback transition-transform hover:scale-125 hover:text-ring rounded-full ock w-12 h-12 text-sidebar-foreground/70 shadow-lg pointer-events-auto"
      >
        <Undo strokeWidth={3} />
      </Button>
      <Button
        ...
        className="backdrop-blur-lg !bg-transparent border absolute right-0 peer/delete transition-transform  hover:scale-125 hover:text-ring shadow-lg rounded-full block w-12 h-12 text-sidebar-foreground/70 pointer-events-auto "
      >
