...
import { PreviewWindow as PreviewWindowComponent } from "@/app/PreviewWindow";

export function PreviewWindow({ previewPath }: { previewPath?: string | null }) {
    ...
    <div className="h-full w-full relative flex flex-col">
      <div className="w-full h-12 bg-sidebar z-10 flex items-center text-sm py-2 font-bold px-4">
        ...
        <div className="flex items-center gap-2 truncate flex-1 justify-center">
          ...
          <span className="font-light font-mono before:content-['['] after:content-[']']">PREVIEW WINDOW</span>
          {" / "}
